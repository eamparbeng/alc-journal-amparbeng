...
import alc.kofiamparbeng.ampjournal.R;
    ...
    public class JournalEntrySwipeToDeleteHandler extends ItemTouchHelper.SimpleCallback {
    private final Context context;
    private final Drawable background;
    private final Drawable xMark;
    private final int xMargin;

    public JournalEntrySwipeToDeleteHandler(Context context) {
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        JournalAdapter.ViewHolder listItemViewHolder =  (JournalAdapter.ViewHolder)viewHolder;
